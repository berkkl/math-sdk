...
class GameConfig(Config):
    ...
    def __init__(self):
        super().__init__()
        self.game_id = "0_0_freegame_demo"  # "0_0_lines"
        ...
        self.special_symbols = {"wild": ["W"], "scatter": ["SA", "SB", "SC"], "multiplier": ["W"], "other": ["S"]}
        ...
        self.anticipation_triggers = {
            self.basegame_type: min(self.custom_freespin_triggers[self.basegame_type]["SA"].keys()) - 1,
            self.freegame_type: min(self.custom_freespin_triggers[self.freegame_type]["SA"].keys()) - 1,
        }
        # Reels
                ...
                distributions=[
                    ...
                    Distribution(
                        ...
                        conditions={
                            ...
                            "scatter_triggers": {3: 10, 4: 5, 5: 1},  # Trigger super-game with 5-scatters
                            "mult_values": {
                                self.basegame_type: {1: 1},
                                self.freegame_type: {
                                    2: 50,
