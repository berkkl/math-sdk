...
class GameConfig(Config):
    ...
    def __init__(self):
        super().__init__()
        self.game_id = "my_game"  # "0_0_lines"
        self.provider_number = 0
        self.working_name = "KRAL BERK"
        self.wincap = 5000.0
        self.win_type = "lines"
        self.rtp = 0.9600
        ...
        self.paytable = {
            (3, "H1"): 2.5, (4, "H1"): 8, (5, "H1"): 50,
            (3, "H2"): 1.5, (4, "H2"): 5, (5, "H2"): 30,
            (3, "H3"): 1.0, (4, "H3"): 3, (5, "H3"): 15,
            (3, "H4"): 0.8, (4, "H4"): 2, (5, "H4"): 10,

            (3, "L1"): 0.5, (4, "L1"): 1.2, (5, "L1"): 6,
            (3, "L2"): 0.4, (4, "L2"): 1, (5, "L2"): 5,
            (3, "L3"): 0.3, (4, "L3"): 0.8, (5, "L3"): 4,
            (3, "L4"): 0.2, (4, "L4"): 0.6, (5, "L4"): 3,
        }
        ...
        self.freespin_triggers = {
            ...
            self.freegame_type: {2: 4, 3: 5, 6: 8, 5: 8},
        }
